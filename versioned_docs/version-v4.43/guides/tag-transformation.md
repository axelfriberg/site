...
2. Application developers can then import and use `setTagTransformer` (_before component definition_)
...
<script
  type="module"
  src="https://cdn.jsdelivr.net/npm/@component/library/dist/my-app.esm.js"
></script>
...
import {
  setTagTransformer,
  renderToString as renderToStringV2,
} from "@component/library/v2/hydrate/index.mjs";
 ...
 * `;
 */
return await renderToStringV2((await renderToString(incomingHtmlString)).html)
  .html;
```
...
export class MyComponent {
  ...
  render() {
    return <Host class="my-button">...</Host>;
  }
}
```
